 ...
 */
final class Version20230308235432 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `like` ADD event_id INT NOT NULL, ADD user_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `like` DROP event_id, DROP user_id');
    }
}
